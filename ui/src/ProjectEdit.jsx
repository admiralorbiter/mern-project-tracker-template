...
import {
  Col, Panel, Form, FormGroup, FormControl, FormLabel,
    ...
    componentDidUpdate(prevProps) {
      ...
      async handleSubmit(e) {
        ...
        if (data) {
          ...
          alert('Updated project successfully'); // eslint-disable-line no-alert
        }
      ...
      render() {
        ...
        return (
          <Panel>
            <Panel.Heading>
              <Panel.Title>{`Editing project: ${id}`}</Panel.Title>
            </Panel.Heading>
            <Panel.Body>
